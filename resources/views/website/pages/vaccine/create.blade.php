        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="{{ route('vaccine.store') }}" method="POST">
                ...
                <label class="block text-sm">
                    ...
                    <input type="text" name="vaccine_name" id="vaccine_name" value="{{ old('vaccine_name') ? old('vaccine_name') : '' }}"
                ...
                <div class="grid gap-6 my-4 md:grid-cols-2 xl:grid-cols-2">
                    <label class="block text-sm">
                        ...
                        <input type="number" name="age_of_first_dose" id="age_of_first_dose"
                            value="{{ old('age_of_first_dose') ? old('age_of_first_dose') : '' }}"
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                ...
                <div>
                    ...
                    <textarea id="notes" rows="4" name="remarks"
                        ...
                        placeholder="Keep a note"></textarea>
                    @error('remarks')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                        </span>
