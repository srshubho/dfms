                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Breed Name</th>
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @forelse ($breeds as $breed)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">{{ $breed->breed_name }}</td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('breed.edit', $breed->id) }}">
                                            ...
                                            <button
                                                ...
                                                aria-label="Delete" id="deleteButton{{ $breed->id }}" data-id="{{ $breed->id }}"
                                                onclick="dataDelete({{ $breed->id }})" @click="openModal">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                            ...
                            @empty
                                <tr colspan="3">
                                    <p class="text-center text-white-100 dark:text-gray-400"> No breeds found </p>
                                </tr>
                            @endforelse
...
@push('scripts')
    <script>
        function dataDelete(id) {
            ...
            let route = "{{ route('breed.destroy', ['breed' => ':id']) }}";
