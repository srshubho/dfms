                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Feeditem Name</th>
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('feeditem.edit', $item->id) }}">
                                            ...
                                            <button
                                                ...
                                                aria-label="Delete" id="deleteButton{{ $item->id }}" data-id="{{ $item->id }}"
                                                onclick="dataDelete({{ $item->id }})" @click="openModal">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                            ...
                            @empty
                                <tr colspan="3">
                                    <p class="text-center text-white-100 dark:text-gray-400"> No feeditems found </p>
                                </tr>
                            @endforelse
...
@push('scripts')
    <script>
        function dataDelete(id) {
            ...
            let route = "{{ route('feeditem.destroy', ['feeditem' => ':id']) }}";
