<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul>
        <li class="relative px-6 py-3">
            @include('admin.includes.active_sidebar', ['links' => ['user', 'user/create', 'user/*/edit']])
            @include('admin.includes.individual_sidebar', [
        ...
        <li class="relative px-6 py-3">
            @include('admin.includes.active_sidebar', ['links' => ['calf', 'calf/create', 'calf/*/edit', 'calf/*']])
            @include('admin.includes.individual_sidebar', [
                'links' => ['calf', 'calf/create', 'calf/*/edit', 'calf/*'],
                'name' => 'Calves',
                'route' => 'admin.calf.index',
                'icon' => '<i class="fa-thin fa-cow"></i>',
            ])
        </li>
        <li class="relative px-6 py-3">
