                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Supplier Phone</th>
                                <th class="px-4 py-3">Supplier Address</th>
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @forelse ($suppliers as $supplier)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">{{ $supplier->supplier_phone }}</td>
                                    <td class="px-4 py-3">{{ $supplier->supplier_address }}</td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <button
                                                ...
                                                aria-label="Delete" id="deleteButton{{ $supplier->id }}" data-id="{{ $supplier->id }}"
                                                onclick="dataDelete({{ $supplier->id }})" @click="openModal({{ $supplier->id }})">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                            ...
                            @empty
                                <tr colspan="5">
                                    <p class="text-center text-white-100 dark:text-gray-400"> No suppliers found </p>
                                </tr>
                            @endforelse
...
@push('scripts')
    ...
    <script>
        function dataDelete(id) {
            ...
            let route = "{{ route('admin.supplier.destroy', ['supplier' => ':id']) }}";
