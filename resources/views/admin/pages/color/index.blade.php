                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <button
                                                ...
                                                aria-label="Delete" id="deleteButton{{ $color->id }}" data-id="{{ $color->id }}"
                                                onclick="dataDelete({{ $color->id }})" @click="openModal({{ $color->id }})">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
...
@push('scripts')
    ...
    <script>
        function dataDelete(id) {
            ...
            let route = "{{ route('admin.color.destroy', ['color' => ':id']) }}";
