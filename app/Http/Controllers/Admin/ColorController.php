...
class ColorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.color.index')->with(['message' => 'Color added successfully!', 'alert-type' => 'success']);
    }
    ...
    public function update(Request $request, Color $color)
    {
        ...
        return redirect()->route('admin.color.index')->with(['message' => 'Color update successfully!', 'alert-type' => 'success']);
    }
