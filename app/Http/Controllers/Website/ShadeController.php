...
class ShadeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('website.pages.shade.index', compact('shades'));
    }
    ...
    public function create()
    {
        ...
        return view('website.pages.shade.create', compact('cowtypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('shade.index')->with(['message' => 'Shade created successfully!', 'alert-type' => 'success']);
    }
    ...
    {
        return view('website.pages.shade.show', compact('shade'));
    }
    ...
    {
        $cowtypes = CowType::all();
        return view('website.pages.shade.edit', compact('shade', 'cowtypes'));
    }
    ...
    public function update(Request $request, Shade $shade)
    {
        ...
        return redirect()->route('shade.index')->with(['message' => 'Shade updated successfully!', 'alert-type' => 'success']);
    }
